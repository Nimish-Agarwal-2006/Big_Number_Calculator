...
\begin{titlepage}
    ...
    {\Huge \textbf{Big Number Calculator} \par}
    \vspace{1cm}
    ...
    \vspace{0.3cm}
    {\large Nimish Agarwal \par}
    {\large CS24BTECH11044 \par}
...
\begin{itemize}
    ...
    \item The class contains functions such as \texttt{neg\_check} and other helper methods.
    \item It will give error if the arguments are not valid(i.e. not big integers)
\end{itemize}
...
\begin{enumerate}
    ...
    \item \(100 \div 789 \approx 0.1267\)
    \item \(997783738 \div (-976) = -1022319\)
    \item \(997783738 \div \texttt{hi} = \text{Exception (Invalid input)}\)
    \item \(99778373 \div \texttt{-99-7} = \text{Exception (Invalid input)}\)
...
\begin{enumerate}
    ...
    \item \(5.344 \times 9.8008 = 52.3924672\)
    \item \(-87.8 \times 9.9 = -869.22\)
    \item \(2 \div 8.00 = 0.25\)
    \item \(-76.27221 \div (-8.87762) = 8.592413172305967\)
    \item \(32.5 \div 0 = \text{Exception (Division by zero)}\)
    \item \(\texttt{25qbc} + 8.2 = \text{Exception (Invalid input)}\)
